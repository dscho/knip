 ...
 */
public final class FinalLabelingMetadata implements LabelingMetadata {
        ...
        public FinalLabelingMetadata(String name, int numDims) {

                m_cspace = new CalibratedSpaceImpl(numDims);
                m_name.setName(name);
        }

        public FinalLabelingMetadata(String name, String source,
                        String... axisLabels) {
        ...
        public FinalLabelingMetadata(String name, String source,
                        AxisType[] axes, double[] calibration) {
                m_name.setName(name);
                m_source.setSource(source);
                m_cspace = new CalibratedSpaceImpl(axes, calibration);
        }

        public FinalLabelingMetadata(Named name, Sourced source,
                        CalibratedSpace cspace) {
                m_name.setName(name.getName());
                m_source.setSource(source.getSource());
                m_cspace = cspace;
        }
