 ...
 *
 * History
 *   14 Jul 2011 (hornm): created
 */
package org.kniplib.ui.event;
...
public class EventService {
        ...
        private final Set<KNIPEvent> m_eventQueue;

        private boolean m_openQueue = true;

        public EventService() {
                m_eventQueue = new HashSet<KNIPEvent>();
        ...
        private void processQueue() {
                while (!m_eventQueue.isEmpty()) {
                        ...
                        KNIPEvent event = m_eventQueue.iterator().next();
