...
import org.kniplib.ui.imgviewer.events.ResetCacheEvent;
import org.kniplib.ui.imgviewer.panels.HiddenViewerComponent;
...
public abstract class AWTImageProvider<T extends Type<T>, I extends RandomAccessibleInterval<T> & IterableInterval<T>>
	 ...
	 */
        ...
        /**
         * {@link ImgRenderer} rendering the {@link Img}
         */
        protected ImgRenderer<T, I> m_renderer;
         ...
         */
        @EventListener
        public void onUpdated(ImgChgEvent<I> e) {
                m_src = e.getInterval();
                ...
                ImgRenderer<T, I>[] renderers = ImgRendererFactory
                                .createSuitableRenderer(m_src);
                if (m_renderer != null) {
                        boolean contained = false;
                        for (ImgRenderer<T, I> renderer : renderers) {
         ...
         */
        protected void renderAndCacheImg() {
                if (m_src == null)
                        return;
                Image awtImage = null;
        ...
        public void loadComponentConfiguration(ObjectInput in)
                ...
                try {
                        m_renderer = (ImgRenderer<T, I>) Class.forName(
