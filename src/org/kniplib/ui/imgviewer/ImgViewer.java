 ...
 * @param <T>
 */
public class ImgViewer<T extends Type<T>, I extends IterableInterval<T> & RandomAccessible<T>>
        ...
        public void addViewerComponent(ViewerComponent panel,
                ...
                if (panel.getPosition().equalsIgnoreCase("north")) {
                        m_northPanels.add(panel);
                } else if (panel.getPosition().equalsIgnoreCase("south")) {
                        m_southPanels.add(panel);
                } else if (panel.getPosition().equalsIgnoreCase("east")) {
                        m_eastPanels.add(panel);
                } else if (panel.getPosition().equalsIgnoreCase("west")) {
                        m_westPanels.add(panel);
                } else if (panel.getPosition().equalsIgnoreCase("center")) {
        ...
        public void setImg(I img, CalibratedSpace axes, Named name) {
                m_eventService.publish(new ImgChgEvent<I>(img, name, axes));
        }
        ...
        public String getComponentConfiguration() throws IOException {
                ...
                try {
                        ...
                        totalOut.close();
                        res = Base64.encodeBase64String(totalBytes
                                        .toByteArray());
