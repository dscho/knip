package org.kniplib.algorithm.waveletfilter;
 ...
 * and converting filters and data into images.
 * </p>
 * 
 * <p>
 ...
 * source for further information.</strong>
 * </p>
 * 
 * @author Tom Gibara
 */
...
public class HaarFilter {
        ...
        /**
         * Constructs a new object for performing filtering. Individual
         * filtering instances are constructed to operate on data of a
         * predetermined size. All arrays passed to a filter must have a length
         * which corresponds to the size specified at construction (specifically
         * size x size).
         * 
         * @param size
         *                the length of the side of all squares of data/filter
         *                values
         */
         ...
         * size x size). See
         * 
         * @see #setIterations(int) for information about the iterations
         *      parameter
         ...
         *                values
         * @param iterations
         *                the number of iterations performed during filtering,
         *                or -1 to use the default value
         * @param fractionalBits
         *                the number of binary fractional bits in the number
         *                representation used in filters, or -1 to use the
         *                default value
         */
        ...
        public HaarFilter(int size, int iterations, int fractionalBits) {
                if (size <= 0)
                        throw new IllegalArgumentException(
                                        "size not strictly positive");
                if (size != Integer.highestOneBit(size))
                        throw new IllegalArgumentException(
                                        "size not a power of two");
                if (size > 4096)
                        throw new IllegalArgumentException(
                                        "size too large to support int size arithmetic");
        ...
        /**
         * The number of fractional bits that will be used in the filtered
         * values returned by the <code>filter</code> method.
         * 
         * @see #setFractionalBits(int) for more information
         * 
         * @return the number of binary fractional bits in the number
         *         representation used in filters, never negative
         */
         ...
         * 
         * @param the
         *                number of iterations performed during filtering, or -1
        ...
        public void setIterations(int iterations) {
                ...
                if (1 << iterations > size)
                        throw new IllegalArgumentException(
                                        "too many iterations for size");
                this.iterations = iterations;
        }

        /**
         * Specifies the number of bits in the integers returned by the
         * <code>filter</code> method that represent fractions of a whole
         * number. If fractionalBits is not zero, these bits will form the least
         * significant bits of the integers. Due to the size constraints that
         * arise from arithmetic on <code>int</code>s the number of fractional
         * bits cannot exceed 23. The sensible default value for the number of
         * fractional bits is twice the number of iterations; this default can
         * be specified by passing a negative number to this method.
         * 
         * @param fractionalBits
         *                the number of binary fractional bits in the number
         *                representation used in filters, or -1 for the default
         *                value
         */
        ...
        public void setFractionalBits(int fractionalBits) {
                ...
                if (fractionalBits > 23)
                        throw new IllegalArgumentException(
                                        "fractionalBits exceeds 23, the largest storable in an int");
         ...
         * array. If no filter array is supplied then a new array is created.
         * The values returned may have been scaled to accomodate fractional
         * bits.
         * 
         * @param values
         *                a byte array of length containing the values to be
         *                filtered, not null
         * @param filter
         *                an array which is to contain the filter values, or
         *                null
        ...
        public int[] filter(byte[] values, int[] filter) {
                ...
                if (values.length != sizeSqr)
                        throw new IllegalArgumentException(
                                        "values array incorrect length");
                if (filter == null) {
                        filter = new int[sizeSqr];
                } else {
                        if (filter.length != sizeSqr)
                                throw new IllegalArgumentException(
                                                "filter array incorrect length");
                }
         ...
         * 
         * If the <code>iterations</code> and <code>fractionalBits</code>
         * parameters of this object have been modified since the filter was
         * created then the data will not be faithfully reconstructed. If the
         * number of fractional bits is less than its default value then the
         * inversion may be imperfect due to accumulated rounding errors.
         * 
         ...
         * 
         * @param filter
         *                an array containing the filter values, not null
         * @param values
         *                an array which is to contain the recovered data, or
         *                null
         * @return the array which contains the recovered data
         */

        /*
         * NOTE: As indicated, this implementation has not been thoroughly
         * tested. In particular, it might be possible that this method could
         * overflow when inverting large filters. I have not yet had the time to
         * prove otherwise.
         */

        public byte[] invert(int[] filter, byte[] values, int err) {
                // validate arguments
                if (filter == null)
                ...
                for (int i = iterations - 1; i >= 0; i--) {
                        ...
                        for (int x = 0; x < length; x++) {
                                ...
                                for (int y = 0; y < length; y += 2) {
                                        ...
                                        if ((Math.abs(b) >> fractionalBits) < err) {
                                                b = 0;
                                        }
                                        t[tIndex] = a + b;
                                        t[tIndex + size] = a - b;
        ...
        /**
         * A utility method for converting filter values generated by this
         * object into an <code>TYPE_BYTE_GRAY</code> <code>BufferedImage</code>
         * . If the <code>fractionalBits</code> parameter of this object has
         * been modified since the filter was created then the image may not be
        ...
        public BufferedImage filterToImage(int[] filter) {
                ...
                image.getWritableTile(0, 0).setDataElements(0, 0, size, size,
                                data);
         ...
         * 
         * @param values
         *                an array containing the data values, not null
         * @return the generated image
         */
