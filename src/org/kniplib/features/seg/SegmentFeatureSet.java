...
import org.kniplib.ops.img.CalculatePerimeter;
import org.kniplib.ops.img.ExtractOutlineImg;
import org.kniplib.ops.img.ImgUtils;
import org.kniplib.ops.interval.ConvexHull2D;
...
public class SegmentFeatureSet implements FeatureSet, SharesObjects {
        ...
        private final ExtractOutlineImg<Img<BitType>> m_outlineOp;
        ...
        public SegmentFeatureSet() {
                ...
                m_outlineOp = new ExtractOutlineImg<Img<BitType>>(false);
        ...
        public void iiUpdated(final IterableInterval<BitType> interval) {
                ...
                if (m_enabled.get(6) || m_enabled.get(7) || m_enabled.get(8)) {
                        if (activeDims > 2) {
                                System.out.println("Perimeter, Convexity and Circularity can only be calculated on 2 dimensional segments. Settings them to Double.Nan");
