...
public final class FeatureFactory {
         ...
         * @param fsets
         */
        public FeatureFactory(boolean enableAll, Collection<FeatureSet> fsets) {
        ...
        public FeatureFactory(boolean enableAll, FeatureSet... fsets) {
                ...
                for (FeatureSet fset : fsets) {
                        ...
                        // them to
                        // the listener map
                        collectFeatureTargetListeners(fset);
         ...
         * listener map
         */
        protected void collectFeatureTargetListeners(Object listener) {
