 ...
 */
public class Rotate2D<T extends Type<T> & Comparable<T>> implements
         ...
         *                center will be used
         */
        public Rotate2D(double angle, int dimIdx1, int dimIdx2,
        ...
        public UnaryOutputOperation<Img<T>, Img<T>> copy() {
                return new Rotate2D<T>(m_angle, m_dimIdx1, m_dimIdx2,
