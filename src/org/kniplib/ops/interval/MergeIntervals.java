...
import org.kniplib.tools.comparators.IntervalComperator;

public final class MergeIntervals implements
                UnaryOutputOperation<Interval[], Interval[]> {
        ...
        @Override
        public final Interval[] compute(final Interval[] intervals,
                        final Interval[] res) {
