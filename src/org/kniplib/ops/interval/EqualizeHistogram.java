 ...
 */
public class EqualizeHistogram<T extends RealType<T>, I extends IterableInterval<T>>
        ...
        public I compute(I in, I r) {
                ...
                int[] histo = new MakeHistogram<T>().compute(r,
                                histogramOp.createEmptyOutput(in)).hist();
