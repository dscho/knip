...
public class FindThreshold<T extends RealType<T>> implements
                UnaryOperation<KNIPLibHistogram, DoubleType> {
         ...
         */
        @Override
        public DoubleType compute(KNIPLibHistogram hist, DoubleType r) {
        ...
        @Override
        public UnaryOperation<KNIPLibHistogram, DoubleType> copy() {
