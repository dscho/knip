 ...
 */
public abstract class ImageConvolution<T extends ComplexType<T>, V extends ComplexType<V>, K extends RandomAccessibleInterval<T> & IterableInterval<T>, M extends RandomAccessibleInterval<V> & IterableInterval<V>>
                implements UnaryOutputOperation<K, K> {

        public abstract void setKernel(final M kernel);
         ...
         *                the value.
         */
        public abstract void setHint(String name, String value);
