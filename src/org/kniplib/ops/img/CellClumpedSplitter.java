...
import org.kniplib.algorithm.extendedem.Attribute;
import org.kniplib.algorithm.extendedem.ExtendedEM;
import org.kniplib.algorithm.extendedem.Instance;
 ...
 */
public class CellClumpedSplitter<T extends RealType<T>, L extends Comparable<L>, I extends RandomAccessibleInterval<T> & IterableInterval<T>>
                implements BinaryOperation<I, Labeling<L>, Labeling<Integer>> {

        private final LocalMaximaForDistanceMap<T, I> m_localMaximaOp;
        ...
        public CellClumpedSplitter(final NeighborhoodType neighborhood,
                ...
                m_localMaximaOp = new LocalMaximaForDistanceMap<T, I>(
                                neighborhood);
        ...
        @Override
        public Labeling<Integer> compute(final I src,
                        final Labeling<L> cellLabeling,
                ...
                final List<long[]> posses = m_localMaximaOp.compute(src,
                                new ArrayList<long[]>());
        ...
        class ClusterThread implements Callable<Long> {
                 ...
                 */
                private final Cursor<T> distanceMapRoiCursor;

                /*
                 * Random Access
                 */
                private final RandomAccess<T> distanceMapRandomAccess;
        ...
        @Override
        public BinaryOperation<I, Labeling<L>, Labeling<Integer>> copy() {
                return new CellClumpedSplitter<T, L, I>(m_neighborhood,
                                m_executor, m_minMaximaSize,
                                m_ignoreValueBelowAvgPrecent, m_maxInterations);
        }
}
