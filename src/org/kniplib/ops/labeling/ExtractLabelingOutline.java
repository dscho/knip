...
public class ExtractLabelingOutline<L extends Comparable<L>> implements
        ...
        public Labeling<L> compute(Labeling<L> op, Labeling<L> r) {
                ...
                RandomAccess<LabelingType<L>> opRa = Views.extendValue(op,
        ...
        public UnaryOperation<Labeling<L>, Labeling<L>> copy() {
                return new ExtractLabelingOutline<L>(m_ct, m_dependencies);
        }
