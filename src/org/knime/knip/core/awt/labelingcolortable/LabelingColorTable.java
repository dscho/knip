 ...
 * ---------------------------------------------------------------------
 *
 * Created on 03.09.2013 by Mia
 */
package org.knime.knip.core.awt.labelingcolortable;

/**
 * Interface to represent a LabelingColorMapping. Each possible label L is mapped to a color.
 *
...
public interface LabelingColorTable {
    ...
    /**
     * Set the color for a label. Color must be a valid RGB color
     *
     * @param l
     * @param col
     */
