...
public class SubPixelLocalization<T extends NumericType<T> & Comparable<T>>
		implements Localizable, Comparable<SubPixelLocalization<T>> {
	...
	public SubPixelLocalization(final long[] pixelCoordinates, T value,
