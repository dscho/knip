...
public class BufferedDataOutputStream extends BufferedOutputStream {
     ...
     * 
     * @param b
     *                The value to be written. Externally true is
    ...
    /**
     * This routine provides efficient writing of arrays of any primitive
     * type. The String class is also handled but it is an error to invoke
     * this method with an object that is not an array of these types. If
     * the array is multidimensional, then it calls itself recursively to
     * write the entire array. Strings are written using the standard 1 byte
     * format (i.e., as in writeBytes).
     * 
     * If the array is an array of objects, then writePrimitiveArray will be
