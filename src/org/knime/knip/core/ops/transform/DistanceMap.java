 ...
 */
public class DistanceMap<T extends RealType<T>, K extends RandomAccessibleInterval<T>, M extends RandomAccessibleInterval<FloatType>>
                        ...
                        for (int i = 0; i < src.numDimensions(); ++i) {
                                ...
                                if (a < MAX_DIMS) {
                                        if (src instanceof CalibratedSpace)
                                                dim_unit[a] = ((CalibratedSpace) src)
                                                                .calibration(i);
                                        else
                                                dim_unit[a] = 1;
