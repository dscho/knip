...
public class IterativeImgToImgOperation<TT extends RealType<TT>> extends
                ConcatenatedBufferedUnaryOperation<Img<TT>> {

        private final UnaryOperation<Img<TT>, Img<TT>> m_op;
        private final int m_numIterations;

        public IterativeImgToImgOperation(UnaryOperation<Img<TT>, Img<TT>> op,
                        int numIterations) {
        ...
        private static <TTT extends RealType<TTT>> UnaryOperation<Img<TTT>, Img<TTT>>[] getOpArray(
                        UnaryOperation<Img<TTT>, Img<TTT>> op, int numIterations) {
        ...
        public UnaryOperation<Img<TT>, Img<TT>> copy() {
                return new IterativeImgToImgOperation<TT>(m_op.copy(),
                                m_numIterations);
        }
}