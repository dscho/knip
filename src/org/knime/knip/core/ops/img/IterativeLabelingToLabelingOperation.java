...
public class IterativeLabelingToLabelingOperation<L extends Comparable<L>>
                extends ConcatenatedBufferedUnaryOperation<Labeling<L>> {

        private final UnaryOperation<Labeling<L>, Labeling<L>> m_op;
        private final int m_numIterations;

        public IterativeLabelingToLabelingOperation(
                        UnaryOperation<Labeling<L>, Labeling<L>> op,
                        int numIterations) {
        ...
        private static <LL extends Comparable<LL>> UnaryOperation<Labeling<LL>, Labeling<LL>>[] getOpArray(
                        UnaryOperation<Labeling<LL>, Labeling<LL>> op,
                        int numIterations) {
        ...
        public UnaryOperation<Labeling<L>, Labeling<L>> copy() {
                return new IterativeLabelingToLabelingOperation<L>(m_op.copy(),
                                m_numIterations);
        }
}