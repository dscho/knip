 ...
 * @param <K>
 */
public class LocalMaximaFinder<T extends RealType<T>, K extends RandomAccessibleInterval<T> & IterableInterval<T>>
        ...
        /* min bound */
        private final double m_minBound;

        /* max bound */
        private final double m_maxBound;
        ...
        public LocalMaximaFinder(NeighborhoodType neighborhood,
        ...
        public List<long[]> compute(final K src, final List<long[]> res) {
                ...
                final ArrayList<LocalMaxima> localMax = new ArrayList<LocalMaxima>(
                                10);
                ...
                while (srcCursor.hasNext()) {
                        ...
                        if (add) {
                                ...
                                localMax.add(new LocalMaxima(srcCursor.get()
                                                .getRealFloat(), pos));
                        }
                }
                ...
                int l = localMax.size();
                for (int i = 0; i < l; ++i) {
                        if (!(localMax.get(i).val > m_minBound && localMax
                                        .get(i).val < m_maxBound)) {
                                localMax.remove(i);
                                --l;
                                --i;
                        }
        ...
        public UnaryOperation<K, List<long[]>> copy() {
                return new LocalMaximaFinder<T, K>(m_neighborhood, m_minBound,
                                m_maxBound);
        }
