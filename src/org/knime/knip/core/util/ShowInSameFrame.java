...
/**
 *
 * Helper class for debugging purposes allowing to show an image in one frame.
 * Every time the image is updated, the image is rendered newly.
 *
